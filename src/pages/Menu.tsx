...
const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Schezwan Veg Noodles', price: '₹89', isVeg: true, image: pasta, subcategory: 'Veg Noodles' },
      { name: 'Shanghai Veg Noodles', price: '₹99', isVeg: true, image: noodles, subcategory: 'Veg Noodles' },
      { name: 'Schezwan Shanghai Veg Noodles', price: '₹109', isVeg: true, image: pasta, subcategory: 'Veg Noodles' },
      { name: 'Corn Noodles', price: '₹109', isVeg: true, image: noodles, subcategory: 'Veg Noodles' },
      { name: 'Baby Corn Noodles', price: '₹109', isVeg: true, image: pasta, subcategory: 'Veg Noodles' },
      { name: 'Mushroom Noodles', price: '₹109', isVeg: true, image: noodles, subcategory: 'Veg Noodles' },
      { name: 'Paneer Noodles', price: '₹109', isVeg: true, image: pasta, subcategory: 'Veg Noodles' },
      { name: 'Butter Garlic Chilli Noodles', price: '₹119', isVeg: true, image: noodles, subcategory: 'Veg Noodles' },
      { name: 'Singapore Noodles', price: '₹119', isVeg: true, image: pasta, subcategory: 'Veg Noodles' },
      { name: 'Egg Noodles', price: '₹99', isVeg: false, image: noodles, subcategory: 'Non-Veg Noodles' },
      { name: 'Egg Schezwan Noodles', price: '₹119', isVeg: false, image: pasta, subcategory: 'Non-Veg Noodles' },
      { name: 'Garlic Chilli Egg Noodles', price: '₹119', isVeg: false, image: noodles, subcategory: 'Non-Veg Noodles' },
      { name: 'Butter Garlic Chilli Egg Noodles', price: '₹129', isVeg: false, image: pasta, subcategory: 'Non-Veg Noodles' },
      { name: 'Chicken Noodles', price: '₹119', isVeg: false, image: noodles, subcategory: 'Non-Veg Noodles' },
      { name: 'Chicken Schezwan Noodles', price: '₹129', isVeg: false, image: pasta, subcategory: 'Non-Veg Noodles' },
      { name: 'Garlic Chilli Chicken Noodles', price: '₹129', isVeg: false, image: noodles, subcategory: 'Non-Veg Noodles' },
      { name: 'Butter Garlic Chilli Chicken Noodles', price: '₹139', isVeg: false, image: pasta, subcategory: 'Non-Veg Noodles' },
    ],
  },
  {
    name: 'Starters',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Mango', price: '₹60', isVeg: true, image: vanillaIceCream, subcategory: 'Single Scoop' },
      { name: 'Butter Scotch', price: '₹60', isVeg: true, image: iceCream, subcategory: 'Single Scoop' },
      { name: 'Black Current', price: '₹60', isVeg: true, image: brownieIcecream, subcategory: 'Single Scoop' },
      ...
      { name: 'Black Current Sundae', price: '₹99', isVeg: true, image: brownieIcecream, subcategory: 'Sundae' },
      { name: 'Mango Sundae', price: '₹120', isVeg: true, image: vanillaIceCream, subcategory: 'Sundae' },
